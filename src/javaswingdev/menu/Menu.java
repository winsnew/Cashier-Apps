...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("Item");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MESSAGE, "Menu"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERM_CONTACT_CALENDAR, "Transaksi"));
